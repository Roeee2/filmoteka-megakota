...
logoutButton.addEventListener('click', ev => {
  firebase
    ...
    .then(data => {
      ...
      loginMenu.classList.remove('non-displayed');
      signupMenu.classList.remove('non-displayed');
      logoutMenu.classList.add('non-displayed');
      emailMenu.classList.add('non-displayed');
